...
public class Constants {
    ...
    // Face
    public final static String FACE_DEFAULT_TAG         = "defaultFace";
    public final static String FACE_RESET_TAG           = "resetFace";
    public final static String FACE_CLICK_TAG           = "clickFace";
    public final static String FACE_WIN_TAG             = "winFace";
    public final static String FACE_LOSE_TAG            = "loseFace";
    // Cells
    ...
    public final static String CELL_DEFAULT_TAG         = "defaultCell";
    public final static String CELL_CLICK_TAG           = "clickCell";
    public final static String CELL_FLAG_TAG            = "flagCell";
    public final static String CELL_UNKNOWN_TAG         = "unknownCell";
    public final static String CELL_UNKNOWN_CLICK_TAG   = "unknownClickCell";
    public final static String CELL_BOMB_TAG            = "bombCell";
    public final static String CELL_BOMB_HIT_TAG        = "bombHitCell";
    public final static String CELL_BOMB_CHECKED_TAG    = "bombCheckedCell";
}
